...
vim.keymap.set(
	...
	{ desc = "Rename word under cursor in file" }
)
...
-- Lazygit (via snacks.nvim). Uses <leader>G to avoid colliding with the
-- <leader>g live-grep mapping. Lazygit's own UI covers merges, diffs, staging,
-- file history and the commit log.
