...
require("lazy").setup({
	spec = {
		...
		-- Linting (configured in plugin/after/lint.lua)
		...
		-- No buffer tabline: buffers are navigated via keymaps (see remap.lua)
		-- and picked with fzf-lua / harpoon instead of a visual tab bar.
