...
--
-- Neovim 0.11 native LSP (vim.lsp.config + vim.lsp.enable) wired the way
-- LazyVim does it: mason installs the servers, mason-lspconfig auto-enables
-- them, completions come from blink.cmp, formatting from conform.nvim, and
-- Dart/Flutter is owned by flutter-tools.
-- ============================================================================
...
-- Reduce LSP log verbosity for performance
...
-- ----------------------------------------------------------------------------
-- LSP keybindings (bound when any server attaches to a buffer)
-- ----------------------------------------------------------------------------
...
-- Auto-install formatters (servers are handled by mason-lspconfig below)
local mti_ok, mti = pcall(require, "mason-tool-installer")
if mti_ok then
    mti.setup({
        -- Pure formatters used by conform. LSP servers (incl. ruff) are handled
        -- by mason-lspconfig. ruff's binary is the same package either way.
        ensure_installed = {
            "stylua",
            "prettierd",
            "gofumpt",
...
-- ----------------------------------------------------------------------------
-- Capabilities: default for every server, enhanced by blink.cmp
-- ----------------------------------------------------------------------------
...
-- ============================================================================
-- FLUTTER / DART (flutter-tools owns the Dart LSP)
-- ============================================================================
